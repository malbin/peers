  ...
  $.fn.smartAutoComplete = function(){    
                              ...
                              //when source is a string
                                ...
                                return $.Deferred(function(dfd){ 
                                  $.ajax({
                                    ...
                                    if (!$(context.context).is(':focus')) { return; } // @FD: Don't show typeahead field after losing focus
    ...
    $.event.special.showResults = {
      ...
      _default: function(ev){    
        ...
        //type ahead
        if(options.typeAhead && (raw_results[0].substr(0, $(context).val().length).toLowerCase() == $(context).val().toLowerCase()) ){
            // @FD: Make it case insensitive
          var suggestion = $(context).val() + raw_results[0].substr($(context).val().length); //options.typeAheadExtractor($(context).val(), raw_results[0]); 
          ...
          typeAheadField.css({
            ...
            zIndex: 1,
            overflow: 'hidden',
            backgroundColor: $(context).css("background-color"), // @FD
    ...
    return this.each(function(i) { 
      ...
      $(this).keydown(function(ev){
        ...
        else if(ev.keyCode == '39' || ev.keyCode == '13' || ev.keyCode == '9'){
