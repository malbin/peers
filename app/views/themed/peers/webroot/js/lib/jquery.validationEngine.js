    ...
    var methods = {
        ...
        _validateField: function(field, options, skipAjaxValidation) {
            ...
            for (var i = 0; i < rules.length; i++) {
                ...
                if (errorMsg !== undefined) {
					// this displays only one error at a time -TC
                    if(promptText == ''){
        ...
        */
        ...
        _buildPrompt: function(field, promptText, type, ajaxed, options) {
			...
			var position_tmp = options.promptPosition;
			// calculated prompt position
			if(field.data("promptPosition")){ position_tmp = field.data("promptPosition") }
			
            // create the prompt content
            var promptContent = $('<div>').addClass("formErrorContent").addClass(position_tmp).html(promptText).appendTo(prompt);
            // create the css arrow pointing at the field
            // note that there is no triangle on max-checkbox and radio
			// showarray disabled as we are creating arrow in css
            if (options.showArrow && 0) {
            ...
            switch (field.data("promptPosition") || options.promptPosition) {
                ...
                case "topRight":
                    if (overflow)
                        ...
                        promptleftPosition += fieldWidth + 40;
                        promptTopPosition -= promptHeight/2 - 16;
                    }
                    break;
                case "topLeft":
                    if (overflow)
                        ...
                        promptleftPosition -= 216; /* 216 = total width of prompt */
                        promptTopPosition -= promptHeight/2 - 16;
                    }
                    break;
                case "topLeftShort":
                    if (overflow)
                        ...
                        promptleftPosition -= 156; /* 156 = total width of prompt */
                        promptTopPosition -= promptHeight/2 - 16;
                    }
                    break;
				case "topCenter":
					promptTopPosition += -promptHeight - 10;
					promptleftPosition += fieldWidth/2;
					break;
                case "centerRight":
